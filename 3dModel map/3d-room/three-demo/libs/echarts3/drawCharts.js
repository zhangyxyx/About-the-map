        ...
        tooltip : {
            ...
            formatter:function(params){
                ...
                if(chartType=="confidence-band"){
                    ...
                    $.each(params,function(i,param){
                        if(param.seriesName!=""&&param.value!="-"){
                            toop += '<br /><span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + param.color + '"></span>';
